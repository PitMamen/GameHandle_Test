...
//    private BluetoothGatt mBluetoothGatt;
    ...
    public final static UUID UUID_HEART_RATE_MEASUREMENT =
            UUID.fromString("91680001-1111-6666-8888-0123456789AB");
...
//    AtomicBoolean changeStart = new AtomicBoolean(false);
    ...
    public void getCharacteristic(String address) {
        ...
        if(mnotyGattService == null) {
            mnotyGattService = getSupportedGattServices(address, UUID.fromString("91680001-1111-6666-8888-0123456789AB"));
        }
        if(mnotyGattService == null) {
...
//            bluetoothGattMap.remove(address);
        ...
        if(writeCharacteristic == null) {
            writeCharacteristic = mnotyGattService
                    .getCharacteristic(UUID.fromString("91680002-1111-6666-8888-0123456789AB"));
        }
        if(writeCharacteristic == null) {
            Log.d(TAG, "mnotyGattService is null,"+address);
            return;
        ...
        if(readCharacteristic == null) {
            readCharacteristic = mnotyGattService
                    .getCharacteristic(UUID.fromString("91680003-1111-6666-8888-0123456789AB"));
        }
        if(readCharacteristic == null) {
            Log.d(TAG, "mnotyGattService is null,"+address);
            return;
